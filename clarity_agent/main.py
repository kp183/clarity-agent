...
def _format_for_ticketing(analysis_str: str, remediation_command: str) -> str:
    ...
    markdown_content = f"""### 🤖 AI-Powered Incident Report
...
**Affected Components:**
{chr(10).join(f'• {component}' for component in analysis_data.get('affected_components', ['unknown']))}
...
def ticket(
    ...
    async def run_async_ticket_generation():
        ...
        console.print()
        console.print("[dim]💡 Tip: Copy the content above and paste it directly into your incident ticket[/dim]")
